...
- [ ] T008 Define command, provider, and domain contracts plus runtime validators
- [ ] T009 Configure error handling, logging, and secret-safe diagnostics
- [ ] T010 Setup environment and settings configuration management
...
- [ ] T011 [P] [US1] Contract test for [boundary] in tests/contract/test_[name].py
- [ ] T012 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T013 [P] [US1] Unit test for anchoring, validation, or normalization logic in tests/unit/test_[name].py
...
- [ ] T018 [US1] Add validation, Markdown integrity checks, and error handling
- [ ] T019 [US1] Add logging or telemetry guards for user story 1 operations
...
- [ ] T020 [P] [US2] Contract test for [boundary] in tests/contract/test_[name].py
...
- [ ] T026 [P] [US3] Contract test for [boundary] in tests/contract/test_[name].py
...
- [ ] TXXX Validate privacy, logging, and settings behavior
...
- Include verification tasks for scope, review flow, provider payloads, and data boundaries when those areas change
