...
5. Force a render failure and confirm the user remains in the Inlinr viewer with a clear error state.
...
- Integration tests for custom editor registration, Explorer-based `.md` open routing, non-Markdown fallback, refresh behavior, and in-viewer error handling.
