...
2. A new user opens a Markdown document in Inlinr and sees subtle in-document guidance that teaches them to select text to begin the inline editing workflow.
